...
<div class="row pl-2">
    <a href="{{asset('storage/excel/import/samples/Импорт_клиентов.xlsx')}}" class="btn btn-outline-success">Скачать
        образец</a>
</div>
<div class="row">
    <form class='col-sm-8 col-lg-6 col-xl-4' action="{{route('admin.client.import.store')}}" method="POST"
